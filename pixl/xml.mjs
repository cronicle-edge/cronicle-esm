...
const XML = function XML(args, opts) {
	...
	if (!this.text.match(/^\s*</)) {
		// try as file path
		var file = this.text;
		this.text = readFileSync(file, { encoding: 'utf8' });
...
export const parse = function (text, opts) {
...
export const encode_entities = function encode_entities(text) {
...
export const encode_attrib_entities = function encode_attrib_entities(text) {
...
export const decode_entities = function decode_entities(text) {
...
export const compose_xml = function compose_xml(node, name, indent, indent_string, eol, sort) {
...
export const always_array = function always_array(obj, key) {
...
export const hash_keys_to_array = function hash_keys_to_array(hash) {
